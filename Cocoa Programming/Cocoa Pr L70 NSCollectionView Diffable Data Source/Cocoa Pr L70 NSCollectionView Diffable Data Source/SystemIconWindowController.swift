...
class SystemIconWindowController: NSWindowController {
    ...
    private func setupDataSource() {
        dataSource = NSCollectionViewDiffableDataSource(collectionView: collectionView, itemProvider: { (collectionView, indexPath, identifier) -> NSCollectionViewItem? in
    ...
    private func filter(_ icons: [SystemIcon], with string: String) -> [SystemIcon] {
        return string.isEmpty ? icons : icons.filter {
