...
/**
 ...
 1. MainMenu.xib
    a. add a label under the cell, set its identifier to be GroupCell; change identifier of "main cell" to ImageCell
 2. Create a new DesktopEntity:NSObject class
    a. create an NSURL property, an NSString
    b. create an -initWithFileURL: and a +entityForURL method
    c. create two subclasses DesktopImageEntity and DesktopFolderEntity
    d. in DesktopImageEntity, add an NSImage property
 3. DesktopEntity.m
    a. implement the -initWithFileURL:fileURL method
    b. implement the +entityForURL: method
    c. implement the method to create the name string
    d. create implementation for the DesktopImageEntity subclass, with a method to create the image property 
 */
